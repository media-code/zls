...
/* harmony import */ var caroucssel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! caroucssel */ "./node_modules/caroucssel/dist/caroucssel.esm.js");

var els = Array.from(document.querySelectorAll('.carousel'));
els.forEach(function (el) {
  var classes = el.classList.value.split(' ');
  var carousel = new caroucssel__WEBPACK_IMPORTED_MODULE_0__.Carousel(el, {
    ...
    buttonTemplate: function buttonTemplate(_ref) {
      var className = _ref.className,
          label = _ref.label,
          title = _ref.title;
      return "<button class=\"".concat(className, "\" title=\"").concat(title, "\">\n            ").concat(label, "\n        </button>");
    },
    buttonPrevious: {
...
var inpsToMonitor = document.querySelectorAll("form input");
...
for (var J = inpsToMonitor.length - 1; J >= 0; --J) {
  ...
  inpsToMonitor[J].addEventListener("mousedown", adjustStyling, false); //-- Initial update. note that IE support is NOT needed.
...
/***/ "./node_modules/caroucssel/dist/caroucssel.esm.js":
/*!********************************************************!*\
  !*** ./node_modules/caroucssel/dist/caroucssel.esm.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
